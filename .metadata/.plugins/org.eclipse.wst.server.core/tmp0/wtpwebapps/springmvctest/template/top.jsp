	...
	<div class="container-fluid">
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li class="active"><a href="/springmvctest/template/mainLayout.jsp">Home</a></li>
					<li><a href="/springmvctest/menu/spring_jdbc.jsp">스프링JDBC</a></li>
					<li><a href="/springmvctest/template/mybatislayout.jsp">myBatis</a></li>
					<li><a href="/springmvctest/menu/advanced_menu.jsp">고급기능</a></li>
