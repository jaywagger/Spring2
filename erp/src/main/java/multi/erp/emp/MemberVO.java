...
/*	public MemberVO(String id, String pass) {
		...
		this.id = id;
		this.pass = pass;
		System.out.println("MemberVO 매개변수2개 생성자");
	}*/
	...
	public MemberVO(String id, String pass, String name, String ssn, String birthday, String marry, String gender,
		...
		super();
		System.out.println("MemberVO 전체 생성자");
		this.id = id;
		this.pass = pass;
		this.name = name;
		this.ssn = ssn;
	...
	public void setId(String id) {
		System.out.println("===========MemberVO setId============");
		this.id = id;
	}
	...
	public String toString() {
		return "MemberVO [id=" + id + ", pass=" + pass + ", name=" + name + ", ssn=" + ssn + ", birthday=" + birthday
				...
				+ ", job_category=" + job_category + ", getId()=" + getId() + ", getPass()=" + getPass()
				+ ", getName()=" + getName() + ", getSsn()=" + getSsn() + ", getBirthday()=" + getBirthday()
				...
				+ ", getDeptname()=" + getDeptname() + ", getMenupath()=" + getMenupath() + ", getJob_category()="
				+ getJob_category() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
