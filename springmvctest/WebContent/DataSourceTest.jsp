...
<body>
	...
	1. WAS에 등록된 자원을 lookup 한다
		- InitialContext의 lookup 메소드를 이용
	2. WAS에서 lookup한 DataSource로 부터 커넥션을 가져온다
		- DriverManager와 동일하게 getConenction을 이용
	</h2>
	<%
		//1. WAS에 등록된 자원을 찾아올 수 있는 기능을 제공하는 객체를 생성
		InitialContext context = new InitialContext();
	
		//2. InitialContext 객체를 이용해서 lookup
		//"jdbc/myspring" context.xml에 설정한 이름
		DataSource ds =
		(DataSource)context.lookup("java:comp/env/jdbc/myspring");
